...
public class ImageGUI extends javax.swing.JFrame {
	...
	//private String urlLocation;
	    ...
	    private void initComponents() {
	        ...
	        Title.setText("4chan Image Downloader");
	                        ...
	                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
	                            .addGroup(layout.createSequentialGroup()
	                                ...
	                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
	                                    ...
	                                    .addComponent(ChooseBoard, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE))
	                                .addGap(28, 28, 28))
	                            .addGroup(layout.createSequentialGroup()
	                                .addGap(48, 48, 48)
	    ...
	    //Download button; downloads selected thread's images
	    ...
	    //Selects folder path for images to be downloader
	    ...
	    //Refreshes the contents of the GUI. Needs work.
	    ...
	    private void ChooseBoardActionPerformed(java.awt.event.ActionEvent evt) {                                            
		 ...
		 DownloadImages.setBoard(Boards.getSelectedIndex());
		 RefreshActionPerformed(evt);
		    //DownloadImages.threads(jComboBox1.getSelectedItem().toString());
